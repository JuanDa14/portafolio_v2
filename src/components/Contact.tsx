...
export const Contact = () => {
	...
	return (
		<Fade triggerOnce className=' py-10 text-black'>
			<section className='px-5 md:px-3 max-w-3xl mx-auto' id='contacto'>
				...
				<div className='text-step--1'>
					...
					<form className='mb-4 text-step--1' onSubmit={onSubmit}>
						<input
							autoCorrect='off'
							required
							name='name'
						...
						<button
							disabled={loading}
							type='submit'
							className='font-semibold px-5 py-2 rounded-md border bg-black text-white hover:text-black hover:bg-white hover:border-black transition-all duration-300 ease-in-out'
						>
